...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      " inline-flex text-center items-center justify-center gap-8 rounded-xl shadow-2xl shadow-black",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      disabled:opacity-50 data-[state=active]:bg-stone-900 data-[state=active]:text-white`,
      className
    )}
    {...props}
  />
